...
public static UserService getInstance(){
    ...
    public boolean AddUser(user u) throws Exception{
        ArrayList<user> result= new ArrayList<>();
         ...
         String url = config.BASE_URL + "/user/t/adduser/";
         req.setUrl(url);
       req.setPost(false);
  ...
  public ArrayList<user> getAllusers(){
        ...
        String url =  config.BASE_URL+"/user/get/users";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
     ...
     public boolean editUser(user u) {
        ...
        System.out.println("********");
       String url =  config.BASE_URL+ "/user/10/modifieruser/"+u.getIdu();
       req.setUrl(url);
       req.setPost(false);
       System.out.println(url);
     req.addArgument("cin", u.getCin().toString());
       ...
       req.addResponseListener(new ActionListener<NetworkEvent>() {
        ...
        String url =  config.BASE_URL+ "/user/supp/supp/supprimerfrommobile/"+u.getIdu();
         req.setUrl(url);
    ...
    public void signin(TextField username,TextField password, Resources rs ) {
        ...
        String url =  config.BASE_URL+ "/Security/Security/mobile/loginuser/?email="+username.getText().toString()+"&password="+password.getText().toString();
    ...
    public void inscription(user u)  {
            ...
            String url = "http://127.0.0.1:8000/Security/isncri/insciptionMobile/?prenom="+u.getPrenom().toString()+"&image="+u.getImage().toString()+"&datenaissance="+u.getDateNaissance()+"&tel="+u.getTel().toString()+"&email="+u.getEmail().toString()+"&password="+u.getPassword().toString()+"&cin="+u.getCin().toString()+"&nom="+u.getNom().toString();
       req = new ConnectionRequest(url, false); //false ya3ni url mazlt matba3thtich lel server
