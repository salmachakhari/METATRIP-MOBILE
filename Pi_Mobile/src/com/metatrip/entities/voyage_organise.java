...
public class voyage_organise extends voyage{
    ...
    public voyage_organise(int Idvo,float pb,String air,int nb,  int nbplaces) {
    ...
    public voyage_organise(int Idvo, float Prix_billet, String Airline, int Nb_nuitees, String etatVoyage, voyage voyage, int Idv,int nbplaces) {
        this.Idvo = Idvo;
        this.Prix_billet = Prix_billet;
        this.Airline = Airline;
        this.Nb_nuitees = Nb_nuitees;
    ...
    public String toString() {
        return "voyage_organise{" + "Idvo=" + Idvo + ", Prix_billet=" + Prix_billet + ", Airline=" + Airline + ", Nb_nuitees=" + Nb_nuitees + ", nbplaces=" + nbplaces + ", etatVoyage=" + etatVoyage + ", voyage=" + voyage + ", Idv=" + Idv + ", string=" + string + '}';
    }
