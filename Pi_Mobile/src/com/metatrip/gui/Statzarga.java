...
public class Statzarga extends com.codename1.ui.Form {
  
         Form current;
    private boolean drawOnMutableImage;
   serviceEvenement vs=new serviceEvenement();
          VoyageOrganiseService vos=new VoyageOrganiseService();
    
    private double nbr_event = ListArticle.nb;
...
HomeForm form;
        public Statzarga(Resources res)  {
             current= this;
  ...
  ;       
    ...
    public void createPieChartForm() {
        ...
        //values
        double prcntFeed = vs.getAllEvenement().size();
        ...
        String []messages = {
            "Statistique nb Evenement % nb voyages organisés"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Evenement",prcntFeed);
